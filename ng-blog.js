...
$__System.registerDynamic("3", ["5"], true, function($__require, exports, module) {
  ;
  var global = this,
      __define = global.define;
  global.define = undefined;
...
$__System.registerDynamic("6", ["3"], false, function(__require, __exports, __module) {
  var _retrieveGlobal = $__System.get("@@global-helpers").prepareGlobal(__module.id, null, null);
  (function() {
    "format global";
    "deps angular";
...
$__System.register('8', ['3', '4', '7'], function (_export) {
  /**
   * Created by bryangill on 10/24/15.
   */
  'use strict';

  var angular, ngRoute, ngSanitize;
  return {
    setters: [function (_) {
      angular = _['default'];
    }, function (_2) {
      ...
      ngSanitize = _3['default'];
    }],
    execute: function () {
      _export('default', angular.module('Vendor', ['ngRoute', 'ngSanitize']));
    }
  };
});
$__System.registerDynamic("9", [], true, function($__require, exports, module) {
  ...
  var global = this,
      __define = global.define;
  global.define = undefined;
  module.exports = "<div data-ng-repeat=\"post in collection\">\n    <div class=\"panel panel-default\">\n        <div class=\"panel-heading\">\n            <h1 class=\"panel-title\" data-ng-bind=\"post.title.rendered\"/>\n        </div>\n        <div class=\"panel-body\">\n            <div data-ng-bind-html=\"post.excerpt.rendered\"></div>\n            <div data-ng-bind-html=\"post.author\"></div>\n            <div data-ng-bind-html=\"post.date_gmt\"></div>\n            <div data-ng-bind-html=\"post.modified_gmt\"></div>\n            <div data-ng-bind-html=\"post.post_tags\"></div>\n        </div>\n    </div>\n</div>";
  global.define = __define;
  return module.exports;
});

$__System.register('a', ['9', 'b'], function (_export) {
    /**
     * Created by bryangill on 10/24/15.
     */
    'use strict';

    var template, SummaryController;
    ...
    return {
        setters: [function (_) {
            ...
            SummaryController = _b['default'];
        }],
        execute: function () {
            _export('default', summaryDirective);
        }
    };
});
$__System.register('b', ['c', 'd'], function (_export) {
    var _createClass, _classCallCheck, summaryService, view, SummaryController;
        ...
        execute: function () {
            ...
            SummaryController = (function () {
                ...
                _createClass(SummaryController, [{
                    key: 'init',
                    value: function init($scope, SummaryService) {
                        view = $scope;
                    ...
                    key: 'retrievePosts',
                    value: function retrievePosts() {
                        summaryService.getPosts().then(function (response) {
...
$__System.register('11', ['c', 'd'], function (_export) {
    var _createClass, _classCallCheck, request, http, q, config, SummaryService;
    ...
    return {
        ...
        execute: function () {
            ...
            SummaryService = (function () {
                function SummaryService($http, $q, configuration) {
            ...
            _export('default', SummaryService);
        }
    };
});
$__System.register('12', ['11', 'a', 'b'], function (_export) {
  /**
   * Created by bryangill on 10/24/15.
   */
  'use strict';

  var service, directive, controller;
  return {
    setters: [function (_) {
      service = _['default'];
    }, function (_a) {
      directive = _a['default'];
    }, function (_b) {
      controller = _b['default'];
    }],
    execute: function () {
      _export('default', angular.module('Summary', []).directive('summary', directive).controller('summaryController', controller).service('SummaryService', service));
    }
  };
});
$__System.register('13', [], function (_export) {
    ...
    return {
        setters: [],
        execute: function () {
            _export('default', angular.module('services.config', []).constant('configuration', {
...
$__System.register('14', ['12', '13'], function (_export) {
  /**
   * Created by bryangill on 10/24/15.
   */
  'use strict';

  var SummaryModule, ConfigurationModule;
  return {
    setters: [function (_) {
      SummaryModule = _['default'];
    }, function (_2) {
      ConfigurationModule = _2['default'];
    }],
    execute: function () {
      _export('default', angular.module('Application', [SummaryModule.name, ConfigurationModule.name]));
    }
  };
});
$__System.register('15', ['8', '14'], function (_export) {
    /**
    ...
    var VendorModule, ApplicationModule, mainModule;
    return {
        setters: [function (_) {
            VendorModule = _['default'];
        }, function (_2) {
            ApplicationModule = _2['default'];
        }],
        execute: function () {
            mainModule = angular.module('mainApp', [VendorModule.name, ApplicationModule.name]).config(['$locationProvider', function ($locationProvider) {
...
$__System.register('1', ['15'], function (_export) {
  /**
   * Created by Gillyd on 10/22/2015.
   */
  'use strict';
...
//# sourceMappingURL=ng-blog.js.map